...
export default class Particles {
	...
	show(time = 1.0) {
		...
		TweenLite.fromTo(this.object3D.material.uniforms.uDepth, time * 0.7, { value: 400.0 }, { value: 4.0 });
	...
	hide(_destroy, time = 0.1) {
		return new Promise((resolve, reject) => {
			...
			TweenLite.to(this.object3D.material.uniforms.uDepth, time, { value: -40.0, ease: Quad.easeIn });
	...
	resize() {
		...
		this.object3D.scale.set(scale, scale, 2);
